...
| Kellergangtür Hof laut Postbau **kein** Fluchtweg | Trotzdem Haftpflicht-Thema: intern beobachtet, von innen nicht öffenbar wenn von außen zugesperrt. Kein „unkritischer Nuki-Kandidat“, bis das Schloss vorgeführt ist. |
...
Die ausführliche, mit allen Repo-Unterlagen abgeglichene Fassung steht in [`versicherung-nuki-unifi.md`](versicherung-nuki-unifi.md). Kurz: Gröpke klärt **Gebäude + Gebäude-Haftpflicht** der Postbaugenossenschaft; der Verein klärt die **Vereins-Haftpflicht** (Anny-Gäste) selbst. Versicherer genehmigen die Montage meist nicht vorher — es geht um Anzeige und Schadenfall.

Gröpkes Frage vermischt Brandschutz und Police. Beides schriftlich, **pro Tür**. Textbausteine für Gröpke und Vereinsversicherer stehen in der Versicherungsdatei, Abschnitte 7 und 8.

## 8. Empfehlung an uns (heute, vor dem Termin)

- Termin **annehmen**, Vorhaltung und **Kellergang-Schloss von innen** vorführen lassen.
- Beide Bauarten nennen: UniFi = Vorhaltung + Fachbetrieb; Nuki Pro + Keypad = DIY, kein NAV. Teamrichtung im Repo: Nuki DIY, UniFi nicht selbst anschließen.
- Gebäudeversicherung über Gröpke/HV, Vereins-Haftpflicht selbst (siehe `versicherung-nuki-unifi.md` und `antwort-groepke.md`).
- Keine Montage an Glastüren Hof. Keine Bestellung Gemeinschaftstüren, bevor Rettungsweg und Einsperrung Kellergang schriftlich klar sind. Apartment-Pilot davon unabhängig möglich, sobald Vereins-Haftpflicht Anny-Gäste trägt.
