# Dokumentation — FreiUndFritz

Software (Anny → Schloss) und Entscheidungsunterlagen für den Bewohnerverein (München, Postbaugenossenschaft).

## Projekt Zutritt (Bewohnerverein)

Maßgeblich für Beschluss, Pilot Apartment, Hausverwaltung:
...
| [zutritt-nuki/rechtliches.md](zutritt-nuki/rechtliches.md) | LStVG, Zuständigkeiten |
| [zutritt-nuki/technik-nuki-anny.md](zutritt-nuki/technik-nuki-anny.md) | Zylinder, Anny, 200er-Limit |
| [zutritt-nuki/systemvergleich-alternativen.md](zutritt-nuki/systemvergleich-alternativen.md) | KleverKey, Salto, … |

Ordner-Übersicht: [zutritt-nuki/README.md](zutritt-nuki/README.md)

## Nuki vs. UniFi / Postbau

Aktuelle Hardware- und Versicherungsfassung (nach Gröpke und UniFi-Diskussion):

| Datei | Inhalt |
|---|---|
| [nuki-vs-unifi.md](nuki-vs-unifi.md) | Entscheidungsgrundlage, Kosten, DIY, PoE |
